...
public class EmployeeValidator {
     ...
     * @param codeDuplicateChechFlag 社員番号の重複チェックを実施するかどうか(実施true しないfalse)
     * @param passwordCheckFlag パスワードの入力チェックを実施するかどうか(するtrue しないfalse)
     * @return エラーのリスト
     */
     ...
     * @param code 社員番号
     * @param codeDuplicateCheckFlag 社員番号の重複チェックを実施するかどうか(するtrueしないfalse)
     * @return エラーメッセージ
     */
     ...
     * @param passwordCheck パスワードの入力チェックを実施するかどうか(するtrueしないfalse )
     * @return エラーメッセージ
     */
